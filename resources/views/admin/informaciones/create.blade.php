        ...
        <div class="col m6 offset-m3">
            ...
            <div class="card">                
                <div class="card-content ">                           
                    ...
                    <div class="card-title">Nuevo información</div>
                    <form action="{{route('informaciones.store')}}" method="POST">
                        ...
                        <div class="row">
                            <div class="input-field col m12">
                                <textarea name="mision" id="mision" class="materialize-textarea"></textarea>
                        ...
                        <div class="row">
                            <div class="input-field col m12">
                                <textarea name="vision" id="vision" class="materialize-textarea"></textarea>
                        ...
                        <div class="row">
                            <div class="input-field col m12">
                                <textarea name="macroproceso" id="macroproceso" class="materialize-textarea"></textarea>
