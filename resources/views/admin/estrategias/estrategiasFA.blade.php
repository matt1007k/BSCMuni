    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <h5 class="text-center bg-dark p-2 text-white d-flex justify-content-between"><span>Estrategias FA</span> <a href="{{route('estrategias.create', $tipo)}}" class="btn btn-outline-success btn-sm text-uppercase">+ estrategia</a></h5>            
            <ul class="list-group">
