<div class="row">
    <div class="col-md-6">
        <div class="foda" style="max-width: 100%;height:auto">
...
<div class="row pb-2">
    ...
    <div class="col-md-6">
        <h5 class="h3 font-weight-bold p-2 text-dark text-uppercase"><span>Estrategias DA</span> <a
                href="{{route('estrategias.create', $tipo)}}" class="btn btn-success">
